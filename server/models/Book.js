...
module.exports.seedInitialBooks = function() {
		...
		if (err) {
			...
			if (collection.length === 0) {
				Book.create({seqNumber: 1, title:'Пътеводител на галактическия стопаджия', author:'Дъглас Адамс',subTitle:'---',taken: false, returnDate: new Date ('---'), inventoryNum:'2013/43', isFormated: true, shelf: '48-2', signature: "55/C13", year: "1949", genre: "Геология Минералогия", subAuthor: "Годев Н."});
